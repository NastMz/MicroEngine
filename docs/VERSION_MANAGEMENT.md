...
This document describes the automated version management system in MicroEngine.

---

## Overview

MicroEngine uses **[Nerdbank.GitVersioning](https://github.com/dotnet/Nerdbank.GitVersioning)** for automatic version generation. The version is read from `version.json` and automatically propagated throughout the codebase at compile time.

**Key benefits:**

-   **Single source of truth:** All version information comes from `version.json`
