...
public abstract class ProceduralShape
{
    ...
    public abstract void Render(IRenderBackend renderBackend, Vector2 position, float rotation = 0f, float scale = 1f);
}
...
public sealed class RectangleShape : ProceduralShape
{
    ...
    /// <inheritdoc/>
    public override void Render(IRenderBackend renderBackend, Vector2 position, float rotation = 0f, float scale = 1f)
    {
